...
export type Module = 'ahj' | 'utility' | 'hoa' | 'financier' | 'equipment' | 'vendors' | 'users' | 'crews' | 'sla' | 'info' | 'releases' | 'feedback' | 'audit' | 'permissions' | 'notifications' | 'queue_config' | 'reasons' | 'doc_requirements' | 'edge_integration' | 'email_onboarding' | 'custom_fields' | 'calendar_sync' | 'feature_flags' | 'organizations' | 'commissions' | 'engineering_config' | 'invoice_rules' | 'pay_scales' | 'pay_distribution' | 'ticket_config' | 'customer_portal' | 'dealer_relationships' | 'partner_api' | 'cost_catalog' | 'dup_review'
...
export const ADMIN_SIDEBAR_ITEMS: SidebarItem[] = [
  ...
  {
    id: 'cost_catalog' as Module, label: 'Cost Catalog', desc: 'Unit rates per template',
  ...
  {
    id: 'dup_review' as Module, label: 'Dup Review', desc: 'Merge SubHub duplicates',
