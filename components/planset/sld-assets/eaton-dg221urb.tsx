...
// Eaton DG221URB 30A 2-pole ESS disconnect — Phase 2 asset.
// Native viewBox 0 0 100 130. Geometric twin of DG222URB; 30A label only diff.
// Anchors: top=(50,0), bottom=(50,130), left=(0,65), right=(100,65).
export function EatonDg221Urb({ x, y, w, h }: AssetProps) {
  const sx = w / 100
  const sy = h / 130
  return (
    <g transform={`translate(${x},${y}) scale(${sx}, ${sy})`} fontFamily="Helvetica, Arial, sans-serif">
      ...
      <text x="50" y="9.5" fontSize="7" fontWeight="bold" fill="#222" textAnchor="middle">DG221URB</text>
      <text x="50" y="15.5" fontSize="5.5" fill="#444" textAnchor="middle">30A / 2P</text>
