...
--   • equipment rows:  is_epc_internal=false, markup_distro_to_epc = 0.005 (chain spread)
--   • EPC labor rows:  is_epc_internal=true,  markup_distro_to_epc = 0
--
...
ALTER TABLE public.project_cost_line_item_templates
  ...
  CHECK (is_epc_internal = false OR markup_distro_to_epc = 0)
  NOT VALID;
...
COMMENT ON CONSTRAINT cost_template_epc_internal_no_markup
  ...
  'EPC-internal labor templates must carry markup_distro_to_epc = 0; only
